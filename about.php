...
<div class="row">
    <div class="column-2-3">
        ...
        <p align="justify">&nbsp;&nbsp;In order to build a mass movement for free software, FSMK organizes GNU/Linux User's Groups (GLUG) in Engineering colleges which conducts various technical sessions throughout the academic session.</p>
...
<div class="row">
    <div class="column-2-3">
        <h2>freedom software, Free as in Freedom</h2>
